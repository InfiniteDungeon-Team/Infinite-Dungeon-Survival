...
public class Enemy : MonoBehaviour
{
    ...
    // When an enemy is set active and ready to attack player, set update its health, damage, etc to match the current wave
